...
INSERT INTO
  work_with
VALUES(102, 403, 12000);
INSERT INTO
  work_with
VALUES(103, 404, 33000);
INSERT INTO
  work_with
...
FROM
  employee;
-- Basically see what values are availble in a column
SELECT
  DISTINCT branch_id
FROM
  employee;